...
/*   Updated: 2023/08/02 19:31:20 by danielga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Descompone cada caracter del string recibido en bits y si es 0 lo envía
 * con la señal SIGUSR1 y si es 1 revisado con AND se envia con SIGUSR2 con la 
 * función kill. Cuando haya enviado los 8 bits, moverá al siguiente caracter 
 * del string.
 * 
